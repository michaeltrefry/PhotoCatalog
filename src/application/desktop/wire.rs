...
pub(super) fn build_identity() -> String {
    ...
    hash.update(
        concat!(
            ...
            include_str!("../../catalog_export_alias.rs"),
            ...
            include_str!("filesystem/native.rs"),
            include_str!("filesystem/export_native.rs"),
            include_str!("export_native.rs"),
            include_str!("native.rs"),
            include_str!("../../catalog_session/native.rs"),
            include_str!("../../catalog_session/export_native.rs"),
            ...
            include_str!("../../filesystem_worker/preview_stage.rs"),
            include_str!("../../catalog_session/export_stage.rs"),
            include_str!("../../filesystem_worker/export_stage.rs"),
            include_str!("../../filesystem_worker/export_executor.rs"),
            ...
            include_str!("../../export_service.rs"),
            include_str!("../../export_service/managed.rs"),
            ...
            include_str!("../../preview/managed_reads.rs"),
