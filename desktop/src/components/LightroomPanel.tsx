...
export function LightroomPanel({controller:c,open,onClose}:{controller:Controller;open:boolean;onClose:()=>void}) {
  ...
  return <Dialog title="Lightroom inspection" onClose={onClose}><div className="lightroom-panel">
    ...
    <Section title="Review and seal an exact approval" open={false}>
      <p>Seal the reviewed selection here, then open “Migrate Lightroom…” to upload the exact seal, approval, policy, optional execution authorization, and supplement or repair documents. Inspection and family selection alone do not import anything. Both interfaces preserve authority documents without parsing and reserializing them.</p>
