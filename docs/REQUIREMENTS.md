...
E7. Organization: folders, hierarchical keywords, ratings, flags, color labels, collections, and filtering by photographic metadata. Preserve meaningful imported distinctions and source provenance rather than flattening them. One consolidated catalog supports multiple levels of nested folders, such as 2014 / January / date, with direct and recursive browsing. Display the existing filesystem folder hierarchy, with every year in the same catalog.
