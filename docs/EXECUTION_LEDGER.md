...
sc-22837 and sc-22838 execute in isolated worktrees after verified completion of sc-22836. The user confirmed that SceneWorks model measurement campaigns own the reference Mac's GPU for several hours. Continue small CPU correctness checks and remote CI; reserve controlled database timings until the shared host is quiet because CPU and GPU workloads share memory and bandwidth.
...
| sc-22838 | In Review | [Merged PR #2](https://github.com/michaeltrefry/PhotoCatalog/pull/2), a0bf374 | Independent review PASS; 31 release tests; 22 private samples/44 deterministic renders; strict public RAW checks; PR CI 34237848026 SUCCESS on three platforms | Verify merged-main CI 34242815786 before Done |
...
- PR #2 final reviewed head 2d30647 passed three-platform CI 34237848026. Merged a0bf374 has the identical tree; its CI 34242815786 is running. No S3 Done claim before terminal merged-state verification.
