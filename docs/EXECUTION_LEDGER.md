...
sc-22836–sc-22842 are verified Done. S8's full headless editing/export qualification has passed; independent final review and cross-platform delivery remain. S9 has an adopted inspection checkpoint and reviewed integration candidate, with its next main run held until S8 delivery and fresh resource admission. Native builds and large-I/O/measurement work use one owned lane. Live Shortcut remains authoritative; this checkpoint was reconciled on 2026-09-10. Sections below the current ledger retain historical checkpoints.
...
| sc-22843 | In Progress | codex/sc-22843-edits; [qualification report](EDIT_QUALIFICATION_RESULTS.md) | 533 cases/249 numerical configurations PASS with zero missed targets; original hashes, large-image/overlap/cleanup evidence reconciled; 377 native and 122 Python tests PASS | Final evidence review, one batched PR, applicable three-platform CI, merge and main CI |
| sc-22844 | In Progress | Frozen v6 adoption; codex/sc-22844-s8-integration at427e9f6 | 15 captures/14 completed outcomes/9,739,671 retained rows independently reconciled; active member has24 verified pages. Source integration reviewed; native gates and main resume pending | After S8 delivery, fresh resource admission for main; finish auxiliary/path/packet phases and family ambiguity review before migration |
