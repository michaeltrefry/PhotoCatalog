...
| sc-22844 | In Progress | [Draft PR #11](https://github.com/michaeltrefry/PhotoCatalog/pull/11); legacy MAIN complete; corrected schema-3 FULL continuing | 47 captures verified. FULL19 clean at 10340; failures 17/18 retained. At `58e7a1a`, macOS/Windows/contracts pass; Linux export-lock failure tracked in sc-23102 | Finish corrected FULL, independently funded paths/packets, family decisions, exact-head CI, merge and terminal merged CI |
| sc-23102 | In Progress | Export-service lock lifetime correction | Deterministic retained-descriptor regressions and independent review in progress | Validate fix on all three platforms; merge and verify tracker closeout |
